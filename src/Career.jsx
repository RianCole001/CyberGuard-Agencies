...
const learningOutcomes = [
  ...
  "Wireless and Cloud Security Auditing",
            ...
            <div className="row justify-content-center">
              <div className="col-lg-10">
                <h1 className="display-4 fw-bold mb-3" style={{ color: accentColor }}>
                  Ethical Hacking & Penetration Testing Bootcard(physical Track)
                </h1>
                <p className="lead text-white-50 mb-5">
                  Step into the world of offensive cybersecurity with our comprehensive Specialist Track, ideal for professionals ready to level up. You'll master <strong>hands-on skills</strong> through guided labs and real-world physical training.
                </p>
              </div>
            </div>
                ...
                <div key={index} className="col-md-6 col-lg-5">
                  <div className={`card ${data.theme} shadow border-0 h-100`}>
                    <div className="card-body text-dark text-start">
                      ...
                      <p className="card-text">Start Date: <strong>{data.startDate}</strong></p>
                      <p className="card-text">Course Duration: <strong>{data.duration}</strong></p>
                      <p className="card-text">Mode of Learning: <strong>{data.mode}</strong></p>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <section id="prereq" className="py-5 bg-dark-subtle text-center">
          <div className="container">
            ...
            <p className="lead mb-4 text-light">
              ...
              <br /><strong>Prerequisite:</strong> Basic understanding of networking and Linux command line usage is highly recommended.
            </p>
